...
AI_VERSIONS = {
    ...
    "python_v3": {
        ...
        "description": "Engine Python mate-aware, có opening book nhỏ và evaluator lai học tín hiệu PST từ Wukong.",
        "engine": "Python",
        "runner": "python_v3",
        "search": "Opening book tại root; Negamax, Alpha-Beta, IDS, Zobrist TT, PVS, LMR, Null Move, Futility, Razoring, Killer/History và quiescence có xử lý chiếu.",
        "evaluation": "Hybrid: tapered material/PST gia tăng; feature nhẹ tại fallback/cửa vào quiescence; breakdown activity và King Safety cho phân tích.",
        "max_depth": 64,
        "time_limit": 0.5,
    },
    "python_v4": {
        ...
        "description": "Engine V3 + sparse piece-square NNUE lượng tử hóa; fallback về heuristic V3 nếu model lỗi.",
        "engine": "Python",
        "runner": "python_v4",
        "search": "Negamax + PVS + LMR + NMP + Futility + Razoring + NNUE Eval",
        "evaluation": "NNUE: piece-type × square features → 128-unit hidden → scalar output, incremental accumulator update.",
        "max_depth": 64,
        "time_limit": 0.5,
    },
}
